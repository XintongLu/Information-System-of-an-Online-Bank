		...
		<div class="col-md-3">
			...
			<div id="MainMenu">
				<div class="list-group panel">
					...
					<a href="#demo4" class="list-group-item list-group-item-success" data-toggle="collapse" data-parent="#MainMenu">Compte épargne &nbsp; <i class="fa fa-caret-down"></i> </a>
					<div class="collapse" id="demo4">
					 ...
					 <a href="/Projet_S8/ServletAlimenterTitre" class="list-group-item">Alimenter</a>
						<a href="/Projet_S8/Actions/cours.jsp" class="list-group-item">Cours de la bourse</a>
					...
					<div class="collapse" id="demo5"> <a href="/Projet_S8/AjouterBeneficiaire" class="list-group-item">Ajouter un bénéficiaire</a> 
					...
					<div class="collapse" id="demo6">
						<a href="/Projet_S8/VirementInterneTitreVersCourant" class="list-group-item">Compte titre vers compte courant </a> 
						<a href="/Projet_S8/VirementInterneTitreVersEpargne" class="list-group-item">Compte titre vers compte épargne</a> 
					</div>

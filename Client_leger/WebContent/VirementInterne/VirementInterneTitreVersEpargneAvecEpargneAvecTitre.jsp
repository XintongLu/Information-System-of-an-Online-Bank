...
<body>
	...
	<div class="row">
		...
		<div class="card col-md-8">
			<div class="card-body">
				<form method="post"
					action="http://localhost:8080/Projet_S8/VirementInterneTitreVersEpargne">

					<div class="col-md-25">
						<div class="text-center">
							<h2>Virement interne : Compte titre vers compte épargne</h2>
						</div>
						...
						<div class="tab-content">
							<div id="home" class="container tab-pane active">
								...
								<div class="input-group mb-5">
									...
									<br><span class="erreur">${alimenter.erreurs['espece']}</span>
								</div>

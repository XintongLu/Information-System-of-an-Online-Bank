...
<body>
	<c:if test="${empty sessionClient}">
		...
		<%@include file="/GererCompte/HeaderAvecEpargneAvecTitreNew.jsp"%><br><br>
	<div class="col-md-0"></div><br>
	<div class="col-md-10"><br>
		<div class="table-responsive"><br>
<br>		

			<h2 class="text-center"> Votre portefeuille d'actions</h2><br><br>
			<table class="table " cellspacing="0"> 
				<thead class="thead-success">
					<tr>
						<th class="text-center">Nom</th>
						<th class="text-center">Prix</th>
						<th class="text-center">Nombre d'actions</th>
				...
				<tbody>
					...
					<c:forEach items="${actions}" var="actions">
						<form
							...
							method="post">
							<tr>
								<td align="center"><c:out value="${actions.nom}" /></td>
								<td align="center"><c:out value="${actions.dernier}" /></td>
								...
								<td align="center"><input name="nom" type="hidden" value="${actions.nom}">
									<button type="submit" class="text-center btn">Vendre</button></td>
							</tr>
						</form>

		...
		<div class="col-md-6">
			...
			<form method="post">
				<div class="card">
					...
					<div class="card-body px-5">
						...
						<br><div class="text-center">
							<p class="${empty connexion.erreurs ? 'succes' : 'erreur'}">
								${connexion.resultat}
						</div>

						<br>
						<div class="text-center">
							<a href="http://localhost:8080/Projet_S8/FormulaireConnexionAdmin">Espace
								Admin</a>
						</div>
						
						<div class="text-center">
							<a href="http://localhost:8080/Projet_S8/FormulaireConnexionManager">Espace
								manager</a>
						</div>
					</div>
				</div>
				...
				<c:if test="${!empty sessionScope.sessionClient}">
					<c:redirect url="/Home/homeClient.jsp" />

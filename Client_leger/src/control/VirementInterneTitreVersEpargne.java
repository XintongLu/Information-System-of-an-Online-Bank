 ...
 */
@WebServlet("/VirementInterneTitreVersEpargne")
public class VirementInterneTitreVersEpargne extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public static final String ATT_ERREURS = "erreurs";
	public static final String ATT_RESULTAT = "resultat";

	public VirementInterneTitreVersEpargne() {
		super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		MetierVirementInterneTitreVersEpargne alimenter = new MetierVirementInterneTitreVersEpargne();
		...
		if (idEpargne != 0) {
			if (idTitre != 0) {
				this.getServletContext().getRequestDispatcher("/VirementInterne/VirementInterneTitreVersEpargneAvecEpargneAvecTitre.jsp")
						.forward(request, response); // Avec Epargne + avec titre
			} else {
				this.getServletContext().getRequestDispatcher("/VirementInterne/VirementInterneTitreVersEpargneAvecEpargneSansTitre.jsp").forward(request,
						response); //Avec Epargne + Sans titre
			}
		} else {
			if (idTitre != 0) {
				this.getServletContext().getRequestDispatcher("/VirementInterne/VirementInterneTitreVersEpargneSansEpargneAvecTitre.jsp")
						.forward(request, response); // Sans Epargne + avec titre
			} else {

				this.getServletContext().getRequestDispatcher("/VirementInterne/VirementInterneTitreVersEpargneSansEpargneSansTitre.jsp").forward(request,

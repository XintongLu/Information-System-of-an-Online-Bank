...
public class Download extends HttpServlet {
    ...
    public void doGet( HttpServletRequest request, HttpServletResponse response ) throws ServletException, IOException {
        ...
        File fichier = new File( "C:\\Program Files\\eclipse\\eclipse-workspace\\worskpace_advancedJava\\Projet S8\\fichiers\\extrait.csv" );
        /* V̩rifie que le fichier ex iste bien */
        if ( !fichier.exists() ) {
            /*
